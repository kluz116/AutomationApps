...
class SecurityForm(forms.ModelForm):
    class Meta:
        model = Security
        fields = ['branch', 'client', 'client_type', 'security_file', 'Security_owner', 'security_type',
                  'security_status',
        ...
        widgets = {
            ...
            'Security_Description': forms.TextInput(
                attrs={'class': 'form-control', 'placeholder': 'Security Description'}),
    ...
    def __init__(self, *args, **kwargs):
        ...
        if 'security_type' in self.data:
            try:
                ...
                self.fields['security_status'].queryset = SecurityStatus.objects.filter(
                    security_type_id=security_type_id).order_by('name')
...
class PasswordChangeForm(forms.Form):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'old_password': forms.PasswordInput(attrs={'class': 'form-control', 'placeholder': 'Party Name'}),
