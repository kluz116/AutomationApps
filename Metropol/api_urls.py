...
nimble_token = "http://10.255.201.179:8093/api/v1/Token/LoginUser"
nimble_close = "http://10.255.201.179:8092/api/v1/Common/CloseAllSessions"
generate_rpt_url = "https://sandbox.analytics.metropol.co.ug/api/v3/report"
get_client_url = "http://10.255.201.179:8092/api/v1/ClientIdentity/GetClient"
get_nin_url = "http://10.255.201.179:8092/api/v1/ClientIdentity/GetClient"
get_reg_url =  "http://10.255.201.179:8092/api/v1/ClientIdentity/GetClient"
getFcs_url = "http://10.255.201.179:8092/api/v1/UserDefinableFields/GetUserFieldsData"
add_nimble_url = "http://10.255.201.179:8092/api/v1/LoanApplication/GetLoanApplication"
url_caps = "https://sandbox.analytics.metropol.co.ug/api/v3/cap"
