...
def getAccontHolderInfo(phone_nmber):
    ...
    if obj_response["ns2:errorResponse"]["@errorcode"] =="ACCOUNTHOLDER_NOT_FOUND":

        return {"firstname": "", "surname": "", "msisdn": "",
                "accountholderstatus": "", "profilename": "", "msg":f'Phone number {phone_nmber} Does not exist..'}
    else:
